#######################################################
# Note: This file was taken from the following path. 
# Copied this since the repo has an MIT license. Not sure if this is the correct interpretation of the licence. 
